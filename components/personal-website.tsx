...
export function PersonalWebsite() {
  // Use a more robust approach to handle client-side rendering
        ...
        <div className="container flex h-16 items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link
              href="#education"
              className={`text-sm font-medium transition-colors ${
                mounted && activeSection === "education"
                  ? "text-primary font-bold"
                  : "text-muted-foreground hover:text-primary"
              }`}
              onClick={handleNavClick}
            ...
            <Link
              href="#research"
              className={`text-sm font-medium transition-colors ${
                mounted && activeSection === "research"
                  ? "text-primary font-bold"
                  : "text-muted-foreground hover:text-primary"
              }`}
              onClick={handleNavClick}
            ...
            <Link
              href="#publications"
              className={`text-sm font-medium transition-colors ${
                mounted && activeSection === "publications"
                  ? "text-primary font-bold"
                  : "text-muted-foreground hover:text-primary"
              }`}
              onClick={handleNavClick}
            ...
            <Link
              href="#conferences"
              className={`text-sm font-medium transition-colors ${
                mounted && activeSection === "conferences"
                  ? "text-primary font-bold"
                  : "text-muted-foreground hover:text-primary"
              }`}
              onClick={handleNavClick}
      ...
      <main className="flex-1">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:gap-16">
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button asChild>
                  <Link href="#research" onClick={handleNavClick}>
                    Research Areas
                  </Link>
                </Button>
                <Button variant="outline" asChild>
                  <Link href="#publications" onClick={handleNavClick}>
                    Publications
                  </Link>
                </Button>
              </div>
        ...
        >
          ...
          <div className="text-muted-foreground max-w-3xl mx-auto">
            <p className="mb-4">
              I am a Postdoctoral Researcher in the Department of Physics at the University of Science & Technology. My
              research focuses on quantum field theory and its applications to condensed matter systems, particularly
              topological phases of matter and strongly correlated electron systems.
            </p>
            <p className="mb-4">
              I received my Ph.D. in Theoretical Physics from Princeton University in 2020, where I worked on developing
              theoretical frameworks for understanding exotic quantum phases in low-dimensional systems.
            </p>
            <p>
              Currently, I collaborate with both theoretical and experimental groups to bridge the gap between
              theoretical predictions and experimental realizations of novel quantum phenomena. My work aims to advance
              our understanding of quantum materials and their potential applications in quantum information processing.
            </p>
          </div>
        </section>
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        <span className="font-medium">Thesis:</span> "Numerical Studies of Quantum Phase Transitions in
                        Spin Systems"
                      </p>
                      <p className="text-muted-foreground">
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      understanding strongly correlated quantum systems. This includes applications to high-temperature
                ...
                <div className="grid gap-4 md:grid-cols-[1fr_2fr] md:gap-8 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      ...
                      exotic properties. Current focus is on materials that could host Majorana fermions for topological
                      quantum computing.
                    </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-sm mt-1 text-muted-foreground">
                          This paper introduced a novel theoretical framework for understanding emergent gauge fields in
                          strongly correlated electron systems, with applications to high-temperature superconductivity.
                        </p>
                      </div>
                      <Link
                        href="#"
